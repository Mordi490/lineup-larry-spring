...
public class LikeRepository {
    ...
    public Like likeLineup(Like like) {
        ...
        boolean lineupExistence = dsl.fetchExists(
                selectFrom(LINEUP).where(LINEUP.ID.eq(like.lineupId()))
        );
        ...
        // going to assume that the like.userId cannot be invalid, double check after auth has been added
    ...
    public void removeLike(Like like) {
        boolean exists = dsl.fetchExists(
                selectFrom(LIKES)
                        ...
                        .and(
                                LIKES.LINEUP_ID.eq(like.lineupId())
                        )
        );

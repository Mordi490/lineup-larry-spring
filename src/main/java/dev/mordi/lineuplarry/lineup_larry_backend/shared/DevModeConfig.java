...
public class DevModeConfig {
    ...
    public ApplicationRunner devModeRunner(Environment environment) {
        return args -> {
            System.out.println(
                "application has started with 'dev' as active profile"
            );
            ...
            // seeded lineup data: designating REYNA and PEARL to be the agent and map with no data
            // associated with them
            lineupRepository.createLineup(
                new Lineup(
                    null,
                    Agent.SOVA,
                    Map.ASCENT,

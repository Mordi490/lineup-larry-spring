...
public class LineupRepository {
  ...
  public Optional<List<LineupWithAuthorDTO>> getLineupsByUserId(
      Long userId, Long pageSize, Long lastValue) {
  ...
  public List<LineupWithAuthorDTO> getLineups(
      String title, Agent agent, Map map, Long pageSize, Long lastValue) {
    var baseQuery =
        dsl.select(
                LINEUP.ID,
                LINEUP.AGENT,

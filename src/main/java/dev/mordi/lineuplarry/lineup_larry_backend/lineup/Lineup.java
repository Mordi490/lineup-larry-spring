...
public record Lineup(@Nullable Long id, @NotNull(message = "agent cannot be null") Agent agent,
        @NotNull(message = "map cannot be null") Map map,
        @NotNull(message = "title cannot be null") @NotBlank(message = "title cannot be blank") @NotEmpty(message = "title cannot be empty") @Size(min = 3, max = 40, message = "Title must be between {min} and {max} characters") String title,
        @NotNull(message = "body cannot be null") @Size(max = 200, message = "A body cannot exceed {max} characters") @NotBlank(message = "body cannot be blank") @NotEmpty(message = "body cannot be empty") String body,
        @NotNull(message = "userId cannot be null") Long userId, @Nullable OffsetDateTime createdAt,

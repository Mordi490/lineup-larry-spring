...
public record LineupWithAuthorDTO
    ...
    public LineupWithAuthorDTO withTitle(String newTitle) {
        return new LineupWithAuthorDTO(this.id, this.agent, this.map, newTitle, this.body, this.userId, this.createdAt, this.updatedAt, this.authorUsername);
    }

    public LineupWithAuthorDTO withBody(String newBody) {
        return new LineupWithAuthorDTO(this.id, this.agent, this.map, this.title, newBody, this.userId, this.createdAt, this.updatedAt, this.authorUsername);
    }
}

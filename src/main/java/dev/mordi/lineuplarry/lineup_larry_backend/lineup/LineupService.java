...
public class LineupService {
  ...
  public List<LineupWithAuthorDTO> getLineup(
      String title, String agent, String map, Long pageSize, Long lastValue) {
    validateTitle(title);
  ...
  public Optional<List<LineupWithAuthorDTO>> getAllLineupsFromUserId(
      Long id, Long pageSize, Long lastValue) {

...
public abstract class InvalidLineupException extends ApiProblemException {
    ...
    protected InvalidLineupException(
        HttpStatus status,
        String problemSlug,
        String title,
        String detail,
    ...
    public static class EmptySearchTitleException
        extends InvalidLineupException
    {

        public EmptySearchTitleException(String str) {
            super(
                HttpStatus.BAD_REQUEST,
                "lineups/search-title-empty",
                "Search title is empty",
    ...
    public static class BlankSearchTitleException
        extends InvalidLineupException
    {
    ...
    public static class IncludedLineupIdException
        extends InvalidLineupException
    {
    ...
    public static class UserIdInvalidException extends InvalidLineupException {
        ...
        public UserIdInvalidException(Long providedUserId) {
            super(
                ...
                "Invalid user id",
                "You cannot create a lineup with userId: '" +
                    providedUserId +
                    "'",
    ...
    public static class ChangedLineupIdException
        extends InvalidLineupException
    {

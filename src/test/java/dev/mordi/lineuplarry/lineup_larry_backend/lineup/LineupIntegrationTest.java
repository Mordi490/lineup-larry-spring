...
public class LineupIntegrationTest {
  ...
  void successfulGetAll() {
    ResponseEntity<List<LineupWithAuthorDTO>> res =
        restTemplate.exchange(
            "/api/lineups", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});

    List<LineupWithAuthorDTO> expectedArray =
        List.of(
            new LineupWithAuthorDTO(
                1L, Agent.SOVA, Map.ASCENT, "lineupOne", "bodyOne", 1L, null, null, "userOne"),
            new LineupWithAuthorDTO(
            ...
            new LineupWithAuthorDTO(
                ...
                "userThree"),
            new LineupWithAuthorDTO(
                13L, Agent.OMEN, Map.SUNSET, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                14L, Agent.VIPER, Map.SPLIT, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                15L, Agent.SAGE, Map.ICEBOX, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                16L, Agent.RAZE, Map.BREEZE, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                17L, Agent.ASTRA, Map.ICEBOX, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                18L, Agent.KAYO, Map.ASCENT, "titleFour", "bodyFour", 3L, null, null, "userThree"),
            new LineupWithAuthorDTO(
                19L,
                Agent.NEON,
                Map.FRACTURE,
                ...
                "userThree"),
            new LineupWithAuthorDTO(
                20L, Agent.FADE, Map.LOTUS, "titleFour", "bodyFour", 3L, null, null, "userThree"));
  ...
  void failGetByTitleOnBlankSearchTitle() {
    ResponseEntity<String> response =
        restTemplate.exchange("/api/lineups?title=    ", HttpMethod.GET, null, String.class);
  ...
  void successfulGetById() {
    ResponseEntity<Optional<LineupWithAuthorDTO>> res =
        restTemplate.exchange(
            "/api/lineups/1", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});

    LineupWithAuthorDTO expectedLineup =
        new LineupWithAuthorDTO(
            1L, Agent.SOVA, Map.ASCENT, "lineupOne", "bodyOne", 1L, null, null, "userOne");
  ...
  void failToGetByIdOnNonexistentId() {
    ResponseEntity<Optional<Lineup>> res =
        restTemplate.exchange(
            "/api/lineups/999", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void successfulGetAllLineupsFromUser() {
    ResponseEntity<List<LineupWithAuthorDTO>> res =
        restTemplate.exchange(
            "/api/lineups/user/2", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});

    // user 2 has lineups, 2 and 3:
    List<LineupWithAuthorDTO> expectedLineups =
        List.of(
            new LineupWithAuthorDTO(
                2L, Agent.SOVA, Map.ASCENT, "lineupTwo", "bodyTwo", 2L, null, null, "userTwo"),
            new LineupWithAuthorDTO(
  ...
  void successfulGetAllLineupsFromUserWithoutLineups() {
    ...
    ResponseEntity<List<LineupWithAuthorDTO>> res =
        restTemplate.exchange(
            "/api/lineups/user/4", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void failGetAlLineupsFromUserWithInvalidUserId() {
    ResponseEntity<String> res =
        restTemplate.exchange(
            "/api/lineups/user/999", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void successfulCreateLineup() {
    Lineup lineupToCreate =
        new Lineup(
            null, Agent.SOVA, Map.ASCENT, "lineup to create", "body to create", 2L, null, null);

    ResponseEntity<Lineup> res =
        restTemplate.postForEntity(
            "/api/lineups", new HttpEntity<>(lineupToCreate, headers), Lineup.class);
  ...
  void successfulCreateLineupWithoutId() {
    ...
    ResponseEntity<Lineup> res =
        restTemplate.postForEntity(
            "/api/lineups", new HttpEntity<>(lineupWithoutIdJsonTemplate, headers), Lineup.class);
  ...
  void failCreateOnMissingMap() {
    ...
    ResponseEntity<String> res =
        restTemplate.postForEntity(
            "/api/lineups", new HttpEntity<>(lineupWithNullMapJsonTemplate, headers), String.class);
  ...
  void successfulUpdate() {
    Lineup updatedLineup =
        new Lineup(1L, Agent.SOVA, Map.ASCENT, "updated title", "updated body", 1L, null, null);
  ...
  void failUpdateOnNullLineupId() {
    Lineup badUpdatedLineup =
        new Lineup(null, Agent.SOVA, Map.ASCENT, "updated title", "updated body", 1L, null, null);
  ...
  void failUpdateOnNullTitle() {
    Lineup badUpdatedLineup =
        new Lineup(1L, Agent.SOVA, Map.ASCENT, null, "updated body", 1L, null, null);
  ...
  void failUpdateOnNullBody() {
    Lineup badUpdatedLineup =
        new Lineup(1L, Agent.SOVA, Map.ASCENT, "updated title", null, 1L, null, null);
  ...
  void failUpdateOnBlankTitle() {
    Lineup badUpdatedLineup =
        new Lineup(1L, Agent.SOVA, Map.ASCENT, "  ", "updated body", 1L, null, null);
  ...
  void failUpdateOnBlankBody() {
    Lineup badUpdatedLineup =
        new Lineup(1L, Agent.SOVA, Map.ASCENT, "updated title", "  ", 1L, null, null);
  ...
  void failUpdateOnChangedId() {
    Lineup badUpdatedLineup =
        new Lineup(33L, Agent.SOVA, Map.ASCENT, "updated title", "updated body", 1L, null, null);
  ...
  void successfulDelete() {
    ResponseEntity<String> res =
        restTemplate.exchange(
            "/api/lineups/2", HttpMethod.DELETE, new HttpEntity<>(null, headers), String.class);
  ...
  void deleteOnNonexistentLineup() {
    ResponseEntity<String> res =
        restTemplate.exchange("/api/lineups/999", HttpMethod.DELETE, null, String.class);
  ...
  void getAllSovaLineups() {
    ...
    List<LineupWithAuthorDTO> expectedResult =
        List.of(
            new LineupWithAuthorDTO(
                1L, Agent.SOVA, Map.ASCENT, "lineupOne", "bodyOne", 1L, null, null, "userOne"),
            new LineupWithAuthorDTO(
  ...
  void failGetAllLineupsOnInvalidAgent() {
    ResponseEntity<String> response =
        restTemplate.exchange(
            "/api/lineups?agent=notARealAgent", HttpMethod.GET, null, String.class);
  ...
  void getAllSunsetLineups() {
    ResponseEntity<List<LineupWithAuthorDTO>> response =
        restTemplate.exchange(
            "/api/lineups?map=sunset", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void failGetAllLineupsFromAnInvalidMap() {
    ResponseEntity<String> response =
        restTemplate.exchange("/api/lineups?map=thisIsNotAMap", HttpMethod.GET, null, String.class);
  ...
  void getAllLineupsFromMapThatDoesNotHaveAnyLineups() { // 10/10 naming yerp
    ResponseEntity<String> response =
        restTemplate.exchange("/api/lineups?map=pearl", HttpMethod.GET, null, String.class);
  ...
  void getAllLineupsFromAgentWithoutLineups() {
    ResponseEntity<String> response =
        restTemplate.exchange("/api/lineups?agent=reyna", HttpMethod.GET, null, String.class);
  ...
  void getAllLineupsFromAgentAndMapWithNoMatches() {
    ResponseEntity<String> response =
        restTemplate.exchange(
            "/api/lineups?map=pearl&agent=jett", HttpMethod.GET, null, String.class);
  ...
  void getAllSovaLineupsWithSpecificTitle() {
    ...
    List<LineupWithAuthorDTO> expectedList =
  ...
  void getAllLineupByAgentMapAndTitle() {
    ...
    List<LineupWithAuthorDTO> expectedLineup =
        List.of(
            new LineupWithAuthorDTO(
                3L,
                Agent.BRIMSTONE,
  ...
  void successfulFindByAgentPagination() {
    ResponseEntity<List<LineupWithAuthorDTO>> response =
        restTemplate.exchange(
            "/api/lineups?agent=sova", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void successfulFindByMapPagination() {
    ResponseEntity<List<LineupWithAuthorDTO>> response =
        restTemplate.exchange(
            "/api/lineups?map=ascent", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void findByAgentAndMapAndTitlePaginatedSeek() {
    ...
    List<Lineup> expectedLineup =
        List.of(new Lineup(6L, Agent.KILLJOY, Map.ICEBOX, "same name", "bodyFour", 3L, null, null));
  ...
  void getAllLineupsPaginated() {
    ResponseEntity<List<LineupWithAuthorDTO>> response =
        restTemplate.exchange(
            "/api/lineups?pageSize=2", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void GetAllLineupsFromNonexistentUser() {
    ResponseEntity<String> response =
        restTemplate.exchange(
            "/api/lineups/user/999?pageSize=10", HttpMethod.GET, null, String.class);
  ...
  void getAllLineupsFromNonexistentUserPaginated() {
    ResponseEntity<String> response =
        restTemplate.exchange(
            "/api/lineups/user/999?lastValue=72", HttpMethod.GET, null, String.class);

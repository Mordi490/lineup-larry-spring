...
public class LineupRepositoryTest {
  ...
  void successfulCreationOfLineup() {
    Lineup newLineup =
        new Lineup(
            ...
            Agent.SOVA,
            Map.ASCENT,
            "newly created lineup",
            "newly created lineup body",
            2L,
            null,
            null);
  ...
  void failCreateDueToUsingNonexistentUserId() {
    Lineup lineupWithNonexistentUserId =
        new Lineup(null, Agent.SOVA, Map.ASCENT, "valid title", "valid body", 999L, null, null);

    assertThrows(
        InvalidLineupException.UserIdInvalidException.class,
        () -> {
  ...
  void successfulUpdate() {
    ...
    Lineup newLineupData =
        new Lineup(
            lineupToFetch.get().id(),
            Agent.KILLJOY,
            Map.SUNSET,
            "updated title",
            "updated body",
            lineupToFetch.get().userId(),
            null,
            null);
  ...
  void deleteNonExistentLineup() {
    ...
    assertThrows(
        InvalidLineupException.NoSuchLineupException.class,
        () -> {
  ...
  void successfulGetAllLineupsFromUser() {
    Optional<List<LineupWithAuthorDTO>> lineupsFromUser =
        lineupRepository.getLineupsByUserId(2L, 20L, null);
  ...
  void successfulGetAllLineupsFromUserWithZeroLineups() {
    Optional<List<LineupWithAuthorDTO>> lineupsFromUser =
        lineupRepository.getLineupsByUserId(4L, 20L, null);
  ...
  void getAllLineupsFromNonexistentUser() {
    ...
    assertThrows(
        InvalidLineupException.NoUserException.class,
        () -> {
  ...
  void getAllLineupsFromUserWithInvalidLastValue() {
    Optional<List<LineupWithAuthorDTO>> lineups =
        lineupRepository.getLineupsByUserId(2L, 20L, 333L);
  ...
  void successfulFindByMapAndTitle() {
    List<LineupWithAuthorDTO> query =
        lineupRepository.getLineups("same name", null, Map.ICEBOX, 20L, null);
  ...
  void findByMapAndTitlePagination() {
    List<LineupWithAuthorDTO> query =
        lineupRepository.getLineups("same name", null, Map.ICEBOX, 20L, 5L);
  ...
  void emptyFindByMapAndTitle() {
    List<LineupWithAuthorDTO> query =
        lineupRepository.getLineups("not a match", null, Map.PEARL, 20L, null);
  ...
  void successfulGetByTitle() {
    List<LineupWithAuthorDTO> lineups =
        lineupRepository.getLineups("same name", null, null, 20L, null);
  ...
  void successfulGetByTitlePageSized() {
    List<LineupWithAuthorDTO> lineups =
        lineupRepository.getLineups("same name", null, null, 1L, null);
  ...
  void successfulGetByTitlePageSizedPagination() {
    List<LineupWithAuthorDTO> lineups =
        lineupRepository.getLineups("same name", null, null, 1L, 5L);
  ...
  void successfulGetByAgentMapAndTitle() {
    List<LineupWithAuthorDTO> lineups =
        lineupRepository.getLineups("lineupThree", Agent.BRIMSTONE, Map.BIND, 20L, null);

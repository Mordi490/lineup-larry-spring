...
public class UserRepositoryTest {
    ...
    // delete user with lineups, cascading, meaning lineups tied to this user also
    // gets delete
    ...
    void successfulGetUserSummary() {
        ...
        UserSummaryDTO expectedResult = new UserSummaryDTO(3L, "userThree", recentlyCreatedLineups,
                mostLikedLineups, recentlyLikedLineups);

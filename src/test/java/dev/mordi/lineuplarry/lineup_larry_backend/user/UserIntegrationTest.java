...
public class UserIntegrationTest {
    ...
    void failGetByIdOnString() {
        ...
        assertThat(res.getBody()).contains(
            "Invalid value 'someString' for parameter 'id'. Expected type: 'Long'"
        );
    }
    ...
    void successfulCreateWithoutId() {
        ...
        ResponseEntity<User> res = restTemplate.postForEntity(
            "/api/users",
            new HttpEntity<>(userWithNoIdJsonTemplate, headers),
            User.class
        );
    ...
    void failCreateOnBlankUsername() {
        ...
        ResponseEntity<String> res = restTemplate.postForEntity(
            "/api/users",
            new HttpEntity<>(userWithBlankUsernameJson, headers),
            String.class
        );
    ...
    void successfulDeleteUserWithLineups() {
        ...
        ResponseEntity<String> userToDeletesLineups = restTemplate.exchange(
            "/api/lineups/user/2",
            HttpMethod.GET,
            null,
            String.class
        ...
        assertThat(userToDeletesLineups.getStatusCode()).isEqualTo(
            HttpStatus.OK
        );
        ...
        assertThat(deleteUserResponse.getStatusCode()).isEqualTo(
        ...
        assertThat(requestDeletedUser.getStatusCode()).isEqualTo(
        ...
        assertThat(requestFirstLineup.getStatusCode()).isEqualTo(
            HttpStatus.NOT_FOUND
        );
        assertThat(requestSecondLineup.getStatusCode()).isEqualTo(
            HttpStatus.NOT_FOUND
        );
    }
    ...
    void successfulGetUserSummary() {
        ...
        assertThat(res.getBody().recentLineups()).isEqualTo(
            recentlyCreatedLineups
        );
        assertThat(res.getBody().mostLikedLineups()).isEqualTo(
            mostLikedLineups
        );
        assertThat(res.getBody().recentlyLikedLineups()).isEqualTo(
